...
MODERATION_REFUSED = "The model's provider refused this input: {reason}"
NO_PROVIDER = "No provider can serve this model right now. Try again later or choose another model."
