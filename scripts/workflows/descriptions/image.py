...
DRAW = Subgraph(
    ...
    nodes=(
        ...
        Node("second", GENERATE, {"model": "microsoft/mai-image-2.6-flash", "model.aspect_ratio": "1:1"}, is_paid=True),
        Node("third", GENERATE, {"model": "recraft/recraft-v4.1-flash", "model.aspect_ratio": "1:1"}, is_paid=True),
        Node("batch", BATCH),
        Node(
            "describe",
            ASK,
...
INSPECT = Subgraph(
    ...
    inputs=(
        ...
        ("image", "clean.model.images.image_1"),
        ("image", "distorted.model.images.image_1"),
        ("image", "defects.model.images.image_1"),
    ),
