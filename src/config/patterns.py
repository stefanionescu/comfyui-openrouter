...
# OpenRouter's own addresses in a reason, such as its credits page, are kept without the scheme.
OPENROUTER_URL_PATTERN = r"https://(openrouter\.ai/\S*?)(?=[.,;:]?(?:\s|$))"
